...
%prep
%setup -n %{kafka_name}-%{kafka_version}-incubating-src
...
cp -r %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/config       %{buildroot}/%{kafka_home}/config
...
cp -r %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/lib          %{buildroot}/%{kafka_home}/
cp -r %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/perf         %{buildroot}/%{kafka_home}/
cp -r %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/project      %{buildroot}/%{kafka_home}/
cp %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/sbt             %{buildroot}/%{kafka_home}/
